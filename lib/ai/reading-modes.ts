...
export const readingModes = [
  ...
  },
  {
    ...
    inputFields: [
      { name: "birth_date", labelTh: "วันเกิด", labelEn: "Birth date", type: "date", required: true },
      { name: "name", labelTh: "ชื่อ (ถ้ามี)", labelEn: "Name", type: "text", placeholder: "ใช้ชื่อจริงหรือนามที่อยากสะท้อน" },
      { name: "question", labelTh: "คำถาม", labelEn: "Question", type: "textarea", required: true, placeholder: "อยากให้เลขช่วยสะท้อนเรื่องอะไร" },
    ],
    responseSections: ["opening", "symbolicMessage", "emotionalReflection", "psychologicalLens", "gentleAdvice", "reflectionQuestions", "microAction", "closing"],
    safetyNotes: ["สื่อความหมายเชิงสัญลักษณ์เท่านั้น ไม่รับประกันโชคหรือผลลัพธ์"],
    toneProfile: "grounded_reflective",
    examplePlaceholders: { question: "เช่น พลังปีนี้กำลังสอนอะไรฉัน" },
  },
  {
    id: "name_analysis",
    ...
    inputFields: [
      { name: "name", labelTh: "ชื่อ", labelEn: "Name", type: "text", required: true, placeholder: "ชื่อจริงหรือชื่อที่ใช้ประจำ" },
      { name: "nickname", labelTh: "ชื่อเล่น", labelEn: "Nickname", type: "text", placeholder: "ถ้าต้องการ" },
      { name: "birth_date", labelTh: "วันเกิด (ถ้ามี)", labelEn: "Birth date", type: "date" },
      { name: "question", labelTh: "คำถาม", labelEn: "Question", type: "textarea", required: true, placeholder: "อยากให้ชื่อสะท้อนเรื่องอะไร" },
    ],
    responseSections: ["opening", "symbolicMessage", "emotionalReflection", "psychologicalLens", "gentleAdvice", "reflectionQuestions", "microAction", "closing"],
  ...
  },
  {
    ...
    inputFields: [
      ...
      { name: "birth_date", labelTh: "วันเกิด", labelEn: "Birth date", type: "date" },
      { name: "question", labelTh: "คำถาม", labelEn: "Question", type: "textarea", required: true, placeholder: "อยากให้สะท้อนจุดไหนของตัวตน" },
    ],
    responseSections: ["opening", "symbolicMessage", "emotionalReflection", "psychologicalLens", "gentleAdvice", "reflectionQuestions", "microAction", "closing"],
